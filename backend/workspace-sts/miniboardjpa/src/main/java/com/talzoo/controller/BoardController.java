...
public interface BoardController {
	...
	public String addFaq(@RequestParam(value = "i_title") String title,
			@RequestParam(value = "i_content") String content, Principal principal) throws Exception;
	...
	public String editFaq(@RequestParam(value = "articleNo") String articleNo,
			...
			RedirectAttributes redirectAttr, Principal principal) throws Exception;

	public String removeFaq(@RequestParam(value = "articleNo") String articleNo, Principal principal) throws Exception;
	...
	public String editAnswer(@RequestParam(value = "articleNo") String articleNo, @RequestParam(value = "answerNo") String answerNo,
			@RequestParam(value = "iii_content") String content, RedirectAttributes redirectAttr,  Principal principal) throws Exception;

	public String removeAnswer(@RequestParam(value = "articleNo") String articleNo, @RequestParam(value = "answerNo") String answerNo,
			RedirectAttributes redirectAttr,  Principal principal) throws Exception;

	public String count(@RequestParam(value = "articleNo")String articleNo, RedirectAttributes redirectAttr) throws Exception;

	public String like(@RequestParam(value = "articleNo")String articleNo, RedirectAttributes redirectAttr) throws Exception;

	public String dislike(@RequestParam(value = "articleNo") String articleNo, RedirectAttributes redirectAttr) throws Exception;

	public String getFaqList(Model model, @RequestParam(value="page", defaultValue="0") int page, @RequestParam(value = "kw", defaultValue = "") String kw) throws Exception;
